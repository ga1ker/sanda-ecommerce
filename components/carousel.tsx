...
export const CarouselHome = () => {
    return (
        <div id="indicators-carousel" className="relative w-full z-50 bg-teal-300/50 mb-6" data-carousel="static">
            <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                <div className="duration-700 ease-in-out" data-carousel-item="active">
                    <img src="/sanda_logotipo.png" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
                </div>
            </div>
